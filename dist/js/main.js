...
const getMinutes = today.getMinutes(); // const getEventDay = new Date(2020, 5, 12) 宣言の中に配列を入れる

const week = ["日", "月", "火", "水", "木", "金", "土"]; // break

r('<p></p>'); // el.insertAdjacentHTML('beforeend', `${getMonth} / ${getDate} (${getDay})`)
